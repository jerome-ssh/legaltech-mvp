-- Change record_id column type to text
...
DROP TRIGGER IF EXISTS audit_matter_team ON matter_team;
DROP TRIGGER IF EXISTS audit_profiles ON profiles;

-- Drop existing function
DROP FUNCTION IF EXISTS log_audit_changes();

-- Create or replace the audit log trigger function with simplified text handling
