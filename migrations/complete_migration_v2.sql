...
-- Create audit log trigger function (moved after table creation)
...
-- RLS Policies for documents (moved after document_permissions table creation)
...
DROP TRIGGER IF EXISTS update_document_tags_updated_at ON document_tags;
