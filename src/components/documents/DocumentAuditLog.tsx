...
export default function DocumentAuditLog({ documentId }: DocumentAuditLogProps) {
  ...
  if (logs.length === 0) return <div className="text-gray-500">No audit log entries found.</div>;
