...
//     return { success: true, message: 'Azure Cognitive Services test successful', result: null };
//   } catch (error: any) {
//     return { success: false, error: error.message };
//   }
// }
...
async function testZoom() {
  try {
    ...
    //   timezone: 'UTC'
    // });
    return { success: true, message: 'Zoom meeting created successfully', meeting: null };
  } catch (error: any) {
    return { success: false, error: error.message };
  }
}
...
async function testGoogleCalendar() {
  try {
    ...
    //   }
    // });
    return { success: true, message: 'Google Calendar event created successfully', event: null };
  } catch (error: any) {
    return { success: false, error: error.message };
  }
}
...
//     return { success: true, message: 'Microsoft Graph API test successful', result: null };
//   } catch (error: any) {
//     return { success: false, error: error.message };
//   }
// }
